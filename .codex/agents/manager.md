...
When generating instructions for other roles, first read the corresponding template file and use it as the instruction scaffold.
...
Before generating any instruction for Planner, Coder, or QA, read the corresponding template file from `prompts/templates/` and base your instruction on it.
